...
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    'djurslinnjam-8000.theianext-0-labs-prod-misc-tools'
    '-us-east-0.proxy.cognitiveclass.ai',
    'djurslinnjam-8000.theiadockernext-0-labs-prod'
    '-theiak8s-4-tor01.proxy.cognitiveclass.ai'
]
CSRF_TRUSTED_ORIGINS = [
    'https://djurslinnjam-8000.theianext-0-labs-prod-misc'
    '-tools-us-east-0.proxy.cognitiveclass.ai',
    'https://djurslinnjam-8000.theiadockernext-0-labs'
